...
import * as pointTypes from '../components/TabTypes';

export default function points(state: object = initialState.points, action: Action) {
  const newPoint = Object.assign({}, action.point);
  var newState = Object.assign([], state[action.pointType]);
  console.log(newState);
  const indexOfpointToDelete = newState.findIndex(point => point.id === newPoint.id);
